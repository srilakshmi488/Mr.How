...
public class NewCourseAdapter extends RecyclerView.Adapter<NewCourseAdapter.Holder> {
    ArrayList<NewCourseModels> newCourseModels;
    Context context;

    public NewCourseAdapter(Context context, ArrayList<NewCourseModels> newCourseModels) {
    ...
    public void onBindViewHolder(@NonNull Holder holder, final int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("covertype", newCourseModels.get(position).getCover_type());
